...
impl SimdBaseOps for I32x4 {
    ...
    #[inline(always)]
    fn and_not(self, rhs: Self) -> Self {
        unsafe { I32x4(_mm_andnot_si128(rhs.0, self.0)) }
    }
...
impl SimdInt32 for I32x4 {
    ...
    fn extend_to_i64(self) -> (Self::SimdI64, Self::SimdI64) {
        unsafe {
            ...
            (
                I64x2::load_from_array([self[0] as i64, self[1] as i64]),
                I64x2::load_from_array([self[2] as i64, self[3] as i64]),
            )
        }
    }
...
impl SimdBaseOps for I64x2 {
    ...
    #[inline(always)]
    fn and_not(self, rhs: Self) -> Self {
        unsafe { I64x2(_mm_andnot_si128(rhs.0, self.0)) }
    }
...
impl SimdBaseOps for F32x4 {
    ...
    #[inline(always)]
    fn and_not(self, rhs: Self) -> Self {
        unsafe { F32x4(_mm_andnot_ps(rhs.0, self.0)) }
    }
...
impl SimdBaseOps for F64x2 {
    ...
    #[inline(always)]
    fn and_not(self, rhs: Self) -> Self {
        unsafe { F64x2(_mm_andnot_pd(rhs.0, self.0)) }
    }
