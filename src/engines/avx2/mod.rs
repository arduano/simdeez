...
impl SimdInt32 for I32x8 {
    ...
    fn extend_to_i64(self) -> (Self::SimdI64, Self::SimdI64) {
        unsafe {
            let a = _mm256_cvtepi32_epi64(_mm256_extracti128_si256(self.0, 0));
            let b = _mm256_cvtepi32_epi64(_mm256_extracti128_si256(self.0, 1));
            (I64x4(a), I64x4(b))
        }
    }
    ...
    fn unsigned_extend_to_i64(self) -> (Self::SimdI64, Self::SimdI64) {
        unsafe {
            let a = _mm256_cvtepu32_epi64(_mm256_extracti128_si256(self.0, 0));
            let b = _mm256_cvtepu32_epi64(_mm256_extracti128_si256(self.0, 1));
            (I64x4(a), I64x4(b))
        }
    }
}
