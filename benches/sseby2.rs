...
fn double_load() -> __m256 {
    unsafe {
        let suma = _mm_add_ps(_mm_loadu_ps(A.get_unchecked(0)),_mm_loadu_ps(B.get_unchecked(0)));
        let sumb = _mm_add_ps(_mm_loadu_ps(A.get_unchecked(4)),_mm_loadu_ps(B.get_unchecked(4)));
